...
@phase_id: 
@story_id: 11722
@story_name: Archive Course
@path: final/7761
@test_case_name: Archive Course.js
@description: 
@test_steps: 
^To check if an Administrator is able to archive the course 
...
describe('Admin Area', () => {
    it("To archive the course ", function () {
        ...
        cy.get('[data-cy="archive_course"]').eq(0).click()
        cy.wait(2000)

/*
    ...
    @phase_id: 10360
    @story_id: 14905
    @story_name: Inside sales change state
    @path: final/7761
    @test_case_name: Inside_sales_change_state.js
    @description:
    @test_steps:
...
describe('Inside sales update state', function () {
    it('Inside sales update state', function () {
        cy.fixture('global').then(data => {
            ...
            cy.get('[data-cy="user_state_text"]').clear().type('United States', { force: true })

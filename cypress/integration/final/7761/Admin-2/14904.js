...
@phase_id: 10360
@story_id: 14904
@story_name: Inside sales change preferred time
@path: final/7761
@test_case_name: Inside_sales_change_preferred_time.js
@description:
@test_steps:
...
@result:
- Preferred time has been updated.
 */

import { Navbar, login_username, login_password, LoginPage, AdminArea, CreateArea } from '../../../../page-objects/pages/index'
describe('Inside sales preferred time', function () {
    it('Inside sales preferred time', function () {
        cy.fixture('global').then(data => {
            ...
            cy.get('[data-cy="pref_time_select"]').select('m', { force: true })

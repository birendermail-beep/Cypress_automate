...
@phase_id: 10360
@story_id: 14906
@story_name: Inside sales change street address
@path: final/7761
@test_case_name: Inside_sales_change_street_address.js
@description:
@test_steps:
...
describe('Inside sales update address', function () {
    it('Inside sales update address', function () {
        cy.fixture('global').then(data => {
            ...
            cy.get('[data-cy="street_add"]').clear().type('Chaitham lines', { force: true })

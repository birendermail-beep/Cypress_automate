/*
    ...
    @phase_id: 10360
    @story_id: 14913
    @story_name: Inside sales communication area demo invite time
    @path: final/7761
    @test_case_name: Inside_sales_communication_area_demo_invite_time.js
    @description:
    @test_steps:
...
describe('Communication area demo invite add time', function() {
    it('Communication area demo invite add time', function() {

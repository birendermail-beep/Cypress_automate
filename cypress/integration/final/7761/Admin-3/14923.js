...
@phase_id: 10306
@story_id: 14923
@story_name: stage_lost
@path: final/7761
@test_case_name: stage_lost.js
@description:
@test_steps:
...
describe('Communication area stage tab', function() {
    it('Communication area stage tab', function() {
        cy.fixture('global').then(data => {
            ...
            cy.get('[data-cy="stage_detail_select"]').select('9', {force: true})
            cy.get('[data-cy="stage_cnmt_box"]').type('Testing Stage S9 Lost', {force: true})

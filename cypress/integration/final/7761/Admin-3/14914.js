/*
    ...
    @phase_id: 10360
    @story_id: 14914
    @story_name: demo invite timezone
    @path: final\7761\Inside_sales_communication_area_demo_invite_timezone.js
    @test_case_name: Inside_sales_communication_area_demo_invite_timezone.js
    @description:
    @test_steps:
...
describe('Communication area demo invite add timezone', function() {
    it('Communication area demo invite add timezone', function() {

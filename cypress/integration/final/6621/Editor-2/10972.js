...
@phase_id: 
@story_id: 10972
@story_name: Plot Sine
@path: final/6621
@test_case_name: Plot Sine.js
@description: Plot Sine
@test_steps:
^delete _points
...
-Repeat step 1 to 4 if you want to delete more sine waves.
-Note: The last plotted point will be the crest and trough point of the sine wave. (https://www.screencast.com/t/3TFZnmwo3nPh)
-Also on hover of the point Delete word will appear on the last plotted point but not on the first plotted point of that sine wave.
...
@result: Plot Sine module open 
*/
import { Navbar, login_username, login_password, LoginPage, EditorPage } from '../../../../page-objects/pages/index'
describe("Plot Sine Module", function() {
    beforeEach('This is login', function() {
            cy.fixture('global').then(data => {
                ...
                cy.get('.icomoon-sine').click({ force: true })
            })
        })
        //plot all edit
    it('plot Sine for edit', function() {

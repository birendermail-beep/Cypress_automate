...
@phase_id: 
@story_id: 10969
@story_name: Plot Points
@path: final/6621
@test_case_name: Plot Points.js
...
@result: Plot Points module open
*/

import { Navbar, login_username, login_password, LoginPage, EditorPage } from '../../../../page-objects/pages/index'
describe("Plot Points Module", function() {
    beforeEach('This is login', function() {
            cy.fixture('global').then(data => {
                ...
                cy.get('.icomoon-pointgraph').click({ force: true })
                cy.wait(5000);
            })
        })
        //plot all edit
    it('plot Points for edit', function() {

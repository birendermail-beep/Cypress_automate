...
@phase_id: 
@story_id: 10970
@story_name: Plot Rays
@path: final/6621
@test_case_name: Plot Rays.js
...
-Click on the required point which you want to delete.
-Repeat step 1 to 4 if you want to delete more points.
-Note: The last plotted point will be the 2nd point of the ray. (https://www.screencast.com/t/pp8dP99YFp)
...
@result: Plot Rays Module open
*/
import { Navbar, login_username, login_password, LoginPage, EditorPage } from '../../../../page-objects/pages/index'
describe("Plot Rays Module", function() {
    beforeEach('This is login', function() {
            cy.fixture('global').then(data => {
                ...
                cy.get('.icomoon-ray').click({ force: true })
                cy.wait(7000);
            })
        })
        //plot all edit
    it('plot Rays for edit', function() {

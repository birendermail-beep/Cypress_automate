...
@phase_id: 
@story_id: 15160
@story_name: inside sales email list sent
@path: final/Dump_Test_Automation
@test_case_name: inside_sales_email_list_sent.js
...
describe('admin', function() {
    ...
    it('Open email status page and select email send option', function() {
        ...
        cy.get('.input-group-append > .dropdown-menu > :nth-child(3) > .dropdown-item').click({force:true});
